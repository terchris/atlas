...
**Completed**: 2026-04-23 — adopted Option A+D. Convention codified in [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md) via [PLAN-reference-tables-convention](../completed/PLAN-reference-tables-convention.md).
...
4. **Naming-conventions.md update** — this convention belongs in [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md), which already has model-naming guidance (`dim_*`, `indicators__*`, `fact_*`, `mart_*`). Adding `ref_<owner>_<concept>` and `crosswalk_<from>_<to>` extends that section. Should be part of the implementing PLAN.
...
- [ ] **PLAN-reference-tables-convention.md** — update [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md) with the prefix rule, the owner-token pattern for `ref_*`, the crosswalk pattern, and the four refresh buckets. Cross-link from `INVESTIGATE-ngo-supply-data-model.md` so its PLAN-A picks up the convention. Estimated effort: ~1 hour, mostly doc work.
...
- **Atlas-internal:**
  - [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md) — current vocabulary, will be extended.
  ...
  - [`docs/stack/erd.md`](../../../stack/erd.md) — auto-generated ERD; will pick up new tables as they land.
