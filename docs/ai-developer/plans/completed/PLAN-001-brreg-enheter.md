...
- **NGO-specific vs generic-parameterised**: investigation [Q4] explicitly resolves this — NF-specific for v1. `brreg-ngo-units` parameterised by NGO slug is a follow-up when the third NGO needs it (likely N.K.S. per [`ngo-landscape.md`](../../../research/ngo-landscape.md)).
