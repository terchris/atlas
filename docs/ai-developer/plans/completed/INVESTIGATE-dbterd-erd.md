...
**Completed**: 2026-04-23 — adopted dbterd; Mermaid ERD lives at [`docs/stack/erd.md`](../../../stack/erd.md), regenerated via [`atlas-data/dbt/regenerate-erd.sh`](../../../../atlas-data/dbt/regenerate-erd.sh). See [PLAN-dbterd-install-and-document.md](../completed/PLAN-dbterd-install-and-document.md) for the implementation details.
...
5. **Document the workflow in [`atlas-data/dbt/README.md`](../../../../atlas-data/dbt/README.md)**: one paragraph + the regeneration command. Cross-link from [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md) so contributors looking at the vocabulary see "the ERD shows current state".
