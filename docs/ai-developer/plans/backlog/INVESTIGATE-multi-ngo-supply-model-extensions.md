...
- [ ] **PLAN-001-multi-ngo-supply-model-extensions.md** (~3–4h)
  ...
  - Update [`naming-conventions.md`](../../../stack/naming-conventions.md) with `source_url`, `chapter_subtype`, `chapter_kommune_coverage`.
  - `dbt run && dbt test`.
...
**Documentation:**
- Extend [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md): `source_url`, `chapter_subtype`, `chapter_kommune_coverage`.
- Auto-regenerate [`docs/stack/erd.md`](../../../stack/erd.md).
