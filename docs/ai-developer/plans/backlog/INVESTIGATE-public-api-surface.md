...
This deferred-but-known posture matches the [`docs/stack/suggested-stack.md`](../../../stack/suggested-stack.md) updated 2026-04-27.
...
- **No external consumer.** The "Dev" persona in [personas.md](../../../research/personas.md) is tertiary and currently speculative.

### What API needs are emerging

- **Tilskuddsmatcher / Lisa** ([goal.md:153](../../../research/goal.md#L153)) — if Lisa-first wins as the v1 wedge, she's the first external-shaped consumer. Her workflow involves filtering open grant calls against need indicators per kommune — exactly the cross-source pattern `fact_kommune_indicators` was built for.
...
- **Public-good positioning** ([goal.md:88](../../../research/goal.md#L88)) — "valuable as a public good on its own — for journalists, researchers, policy planners". An API is how that promise becomes real.
...
Naming follows the [`docs/stack/naming-conventions.md`](../../../stack/naming-conventions.md) `mart_<feature>` pattern (feature-named, not entity-named):
...
- [`docs/ideas/semantic-data-platform-discussion.md`](../../../ideas/semantic-data-platform-discussion.md) — the conversation that landed on dbt-MCP-first; this plan extends that thinking to the HTTP API.
- [`docs/research/goal.md`](../../../research/goal.md) — public-good positioning that motivates the API; Lisa-first decision (Open Decision #1) gates the urgency.
- [`docs/research/personas.md`](../../../research/personas.md) — Dev / Ola / Lisa personas this serves.
