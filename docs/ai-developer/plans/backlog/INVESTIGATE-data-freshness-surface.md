...
Leaning D.2a or D.2c depending on which the rest of Atlas uses; this is a "match whatever else does." Check [`docs/stack/suggested-stack.md`](../../../stack/suggested-stack.md) during the actual investigation.
...
- [ ] Decide Q10/Q11/Q12 with the frontend approach (verify stack against [`docs/stack/suggested-stack.md`](../../../stack/suggested-stack.md)).
