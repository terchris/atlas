...
-- indicators__ssb_12063 — the per-source indicator relation for `ssb-12063`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-12063, NOT ATLAS.
...
-- source_id=ssb-12063, and through the published ref_* lists where one exists.
--
