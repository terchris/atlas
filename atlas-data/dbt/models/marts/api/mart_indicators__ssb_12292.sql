...
-- indicators__ssb_12292 — the per-source indicator relation for `ssb-12292`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-12292, NOT ATLAS.
...
-- source_id=ssb-12292, and through the published ref_* lists where one exists.
--
