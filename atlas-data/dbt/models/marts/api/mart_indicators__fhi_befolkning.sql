...
-- indicators__fhi_befolkning — the per-source indicator relation for `fhi-befolkning`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-BEFOLKNING, NOT ATLAS.
...
-- source_id=fhi-befolkning, and through the published ref_* lists where one exists.
--
