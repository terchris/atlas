...
-- indicators__ssb_06947 — the per-source indicator relation for `ssb-06947`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-06947, NOT ATLAS.
...
-- source_id=ssb-06947, and through the published ref_* lists where one exists.
--
