...
-- indicators__fhi_mediebruk_some — the per-source indicator relation for `fhi-mediebruk-some`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-MEDIEBRUK-SOME, NOT ATLAS.
...
-- source_id=fhi-mediebruk-some, and through the published ref_* lists where one exists.
--
