...
-- indicators__ssb_12944 — the per-source indicator relation for `ssb-12944`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-12944, NOT ATLAS.
...
-- source_id=ssb-12944, and through the published ref_* lists where one exists.
--
