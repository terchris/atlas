...
-- dim_activity — Atlas's canonical activity dimension, each row pointing at a ref_atlas_service_category code. ⚠️ That category mapping is Atlas's editorial judgement, not the owner's classification.
--
-- ══════════════════════════════════════════════════════════════════════════
