...
-- indicators__fhi_innvkat — the per-source indicator relation for `fhi-innvkat`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-INNVKAT, NOT ATLAS.
...
-- source_id=fhi-innvkat, and through the published ref_* lists where one exists.
--
