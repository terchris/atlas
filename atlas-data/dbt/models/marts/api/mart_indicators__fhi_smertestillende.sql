...
-- indicators__fhi_smertestillende — the per-source indicator relation for `fhi-smertestillende`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-SMERTESTILLENDE, NOT ATLAS.
...
-- source_id=fhi-smertestillende, and through the published ref_* lists where one exists.
--
