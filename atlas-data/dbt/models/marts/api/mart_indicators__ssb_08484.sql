...
-- indicators__ssb_08484 — the per-source indicator relation for `ssb-08484`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-08484, NOT ATLAS.
...
-- source_id=ssb-08484, and through the published ref_* lists where one exists.
--
-- 🔵 A VIEW, not a copy — the indicator model is already a table in marts.

select *
from {{ ref('indicators__ssb_08484') }}
