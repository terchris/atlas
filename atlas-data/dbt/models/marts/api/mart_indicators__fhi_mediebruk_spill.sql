...
-- indicators__fhi_mediebruk_spill — the per-source indicator relation for `fhi-mediebruk-spill`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-MEDIEBRUK-SPILL, NOT ATLAS.
...
-- source_id=fhi-mediebruk-spill, and through the published ref_* lists where one exists.
--
