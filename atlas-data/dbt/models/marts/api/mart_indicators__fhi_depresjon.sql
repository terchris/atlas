...
-- indicators__fhi_depresjon — the per-source indicator relation for `fhi-depresjon`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-DEPRESJON, NOT ATLAS.
...
-- source_id=fhi-depresjon, and through the published ref_* lists where one exists.
--
