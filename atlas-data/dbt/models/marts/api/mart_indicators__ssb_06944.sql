...
-- indicators__ssb_06944 — the per-source indicator relation for `ssb-06944`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-06944, NOT ATLAS.
...
-- source_id=ssb-06944, and through the published ref_* lists where one exists.
--
