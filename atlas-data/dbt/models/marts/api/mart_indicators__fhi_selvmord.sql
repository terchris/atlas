...
-- indicators__fhi_selvmord — the per-source indicator relation for `fhi-selvmord`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-SELVMORD, NOT ATLAS.
...
-- source_id=fhi-selvmord, and through the published ref_* lists where one exists.
--
