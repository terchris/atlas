...
-- indicators__fhi_fortrolig_venn — the per-source indicator relation for `fhi-fortrolig-venn`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-FORTROLIG-VENN, NOT ATLAS.
...
-- source_id=fhi-fortrolig-venn, and through the published ref_* lists where one exists.
--
