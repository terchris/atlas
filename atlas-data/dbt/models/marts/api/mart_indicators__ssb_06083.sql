...
-- indicators__ssb_06083 — the per-source indicator relation for `ssb-06083`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-06083, NOT ATLAS.
...
-- source_id=ssb-06083, and through the published ref_* lists where one exists.
--
