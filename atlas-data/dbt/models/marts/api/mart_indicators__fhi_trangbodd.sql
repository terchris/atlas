...
-- indicators__fhi_trangbodd — the per-source indicator relation for `fhi-trangbodd`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-TRANGBODD, NOT ATLAS.
...
-- source_id=fhi-trangbodd, and through the published ref_* lists where one exists.
--
