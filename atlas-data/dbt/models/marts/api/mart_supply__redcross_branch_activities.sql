...
-- supply__redcross_branch_activities — What each Røde Kors branch does, one row per branch × activity. `global_activity_name` is Red Cross's own canonical term; `local_activity_name` is the per-chapter display string.
--
-- ══════════════════════════════════════════════════════════════════════════
