...
-- indicators__ssb_08764 — the per-source indicator relation for `ssb-08764`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-08764, NOT ATLAS.
...
-- source_id=ssb-08764, and through the published ref_* lists where one exists.
--
