...
-- indicators__fhi_alkohol — the per-source indicator relation for `fhi-alkohol`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-ALKOHOL, NOT ATLAS.
...
-- source_id=fhi-alkohol, and through the published ref_* lists where one exists.
--
