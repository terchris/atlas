...
-- indicators__ssb_07459 — the per-source indicator relation for `ssb-07459`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-07459, NOT ATLAS.
...
-- source_id=ssb-07459, and through the published ref_* lists where one exists.
--
-- 🔵 A VIEW, not a copy — the indicator model is already a table in marts.

select *
from {{ ref('indicators__ssb_07459') }}
