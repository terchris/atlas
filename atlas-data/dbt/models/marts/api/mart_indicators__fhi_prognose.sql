...
-- indicators__fhi_prognose — the per-source indicator relation for `fhi-prognose`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-PROGNOSE, NOT ATLAS.
...
-- source_id=fhi-prognose, and through the published ref_* lists where one exists.
--
