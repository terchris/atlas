...
-- indicators__ssb_12131 — the per-source indicator relation for `ssb-12131`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-12131, NOT ATLAS.
...
-- source_id=ssb-12131, and through the published ref_* lists where one exists.
--
