...
-- indicators__ssb_09406 — the per-source indicator relation for `ssb-09406`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-09406, NOT ATLAS.
...
-- source_id=ssb-09406, and through the published ref_* lists where one exists.
--
-- 🔵 A VIEW, not a copy — the indicator model is already a table in marts.

select *
from {{ ref('indicators__ssb_09406') }}
