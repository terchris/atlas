...
-- indicators__ssb_12132 — the per-source indicator relation for `ssb-12132`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-12132, NOT ATLAS.
...
-- source_id=ssb-12132, and through the published ref_* lists where one exists.
--
