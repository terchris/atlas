...
-- indicators__fhi_befolkningsvekst — the per-source indicator relation for `fhi-befolkningsvekst`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-BEFOLKNINGSVEKST, NOT ATLAS.
...
-- source_id=fhi-befolkningsvekst, and through the published ref_* lists where one exists.
--
