...
-- indicators__fhi_mediebruk_underhold — the per-source indicator relation for `fhi-mediebruk-underhold`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-MEDIEBRUK-UNDERHOLD, NOT ATLAS.
...
-- source_id=fhi-mediebruk-underhold, and through the published ref_* lists where one exists.
--
