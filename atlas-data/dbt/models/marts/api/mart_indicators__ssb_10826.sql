...
-- indicators__ssb_10826 — the per-source indicator relation for `ssb-10826`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-10826, NOT ATLAS.
...
-- source_id=ssb-10826, and through the published ref_* lists where one exists.
--
-- 🔵 A VIEW, not a copy — the indicator model is already a table in marts.

select *
from {{ ref('indicators__ssb_10826') }}
