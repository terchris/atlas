...
-- indicators__fhi_bor_alene — the per-source indicator relation for `fhi-bor-alene`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-BOR-ALENE, NOT ATLAS.
...
-- source_id=fhi-bor-alene, and through the published ref_* lists where one exists.
--
