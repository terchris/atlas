...
-- indicators__fhi_livskvalitet — the per-source indicator relation for `fhi-livskvalitet`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-LIVSKVALITET, NOT ATLAS.
...
-- source_id=fhi-livskvalitet, and through the published ref_* lists where one exists.
--
