...
-- indicators__ssb_06913 — the per-source indicator relation for `ssb-06913`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-06913, NOT ATLAS.
...
-- source_id=ssb-06913, and through the published ref_* lists where one exists.
--
