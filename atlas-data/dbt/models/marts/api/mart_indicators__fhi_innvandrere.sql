...
-- indicators__fhi_innvandrere — the per-source indicator relation for `fhi-innvandrere`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-INNVANDRERE, NOT ATLAS.
...
-- source_id=fhi-innvandrere, and through the published ref_* lists where one exists.
--
