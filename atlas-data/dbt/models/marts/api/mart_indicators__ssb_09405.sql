...
-- indicators__ssb_09405 — the per-source indicator relation for `ssb-09405`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-09405, NOT ATLAS.
...
-- source_id=ssb-09405, and through the published ref_* lists where one exists.
--
-- 🔵 A VIEW, not a copy — the indicator model is already a table in marts.

select *
from {{ ref('indicators__ssb_09405') }}
