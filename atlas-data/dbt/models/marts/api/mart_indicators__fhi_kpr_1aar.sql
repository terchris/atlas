...
-- indicators__fhi_kpr_1aar — the per-source indicator relation for `fhi-kpr-1aar`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-KPR-1AAR, NOT ATLAS.
...
-- source_id=fhi-kpr-1aar, and through the published ref_* lists where one exists.
--
