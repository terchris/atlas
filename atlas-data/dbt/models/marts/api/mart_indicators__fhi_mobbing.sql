...
-- indicators__fhi_mobbing — the per-source indicator relation for `fhi-mobbing`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-MOBBING, NOT ATLAS.
...
-- source_id=fhi-mobbing, and through the published ref_* lists where one exists.
--
