...
-- indicators__fhi_neet — the per-source indicator relation for `fhi-neet`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-NEET, NOT ATLAS.
...
-- source_id=fhi-neet, and through the published ref_* lists where one exists.
--
