...
-- indicators__fhi_hasj — the per-source indicator relation for `fhi-hasj`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS FHI-HASJ, NOT ATLAS.
...
-- source_id=fhi-hasj, and through the published ref_* lists where one exists.
--
