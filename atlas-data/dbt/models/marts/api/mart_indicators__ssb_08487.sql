...
-- indicators__ssb_08487 — the per-source indicator relation for `ssb-08487`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-08487, NOT ATLAS.
...
-- source_id=ssb-08487, and through the published ref_* lists where one exists.
--
