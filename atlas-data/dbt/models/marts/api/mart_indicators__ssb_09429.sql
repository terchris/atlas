...
-- indicators__ssb_09429 — the per-source indicator relation for `ssb-09429`, published
...
--
-- 🔴 stability:source. THE COLUMN SET HERE FOLLOWS SSB-09429, NOT ATLAS.
...
-- source_id=ssb-09429, and through the published ref_* lists where one exists.
--
