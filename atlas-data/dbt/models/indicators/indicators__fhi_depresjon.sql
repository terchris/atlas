...
-- share of youth respondents reporting depressive symptoms reaching the symptomatic threshold.
--
...
--   DEPRESJON  always "Ja"
--   SOES   4 codes — "0" combined plus 1/2/3 SES levels. THIS SOURCE ONLY.
--
...
select
  'fhi-depresjon'::text     as source_id,
  ...
  depresjon_code          as symptom_threshold,
