...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 650:
-- population by immigrant category (1st gen, 2nd gen, combined).
--
...
select
  ...
  innvkat_code          as immigrant_category,
  landbak_code          as country_background,
