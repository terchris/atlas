...
-- share of youth respondents reporting painkiller use at least weekly.
--
...
select
  'fhi-smertestillende'::text     as source_id,
...
from {{ source('raw', 'fhi_smertestillende') }}
