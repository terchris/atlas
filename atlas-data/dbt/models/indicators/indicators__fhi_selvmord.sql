...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 344:
-- suicide deaths, 5-year rolling windows, FHI-smoothed.
--
...
select
  'fhi-selvmord'::text          as source_id,
