...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 175:
-- population with immigrant background, by origin region.
--
...
select
  'fhi-innvandrere'::text       as source_id,
...
from {{ source('raw', 'fhi_innvandrere') }}
