...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 171:
-- population projections, by age band and forecast horizon.
--
...
select
  'fhi-prognose'::text          as source_id,
  ...
  prognoseaar_code      as projection_year,
