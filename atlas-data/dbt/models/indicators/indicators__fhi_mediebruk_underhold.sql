...
-- share of youth respondents reporting more than 3 hours per day on streaming / entertainment media.
--
...
select
  'fhi-mediebruk_underhold'::text     as source_id,
...
from {{ source('raw', 'fhi_mediebruk_underhold') }}
