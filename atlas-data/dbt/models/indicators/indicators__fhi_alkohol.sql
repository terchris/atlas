...
-- share of youth respondents reporting alcohol use one or more times in the past year.
--
...
--   ANTALL_GANGER  always "engangellerflere"
...
select
  ...
  antall_ganger_code          as frequency_band,
