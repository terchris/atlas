...
-- share of youth respondents reporting high self-reported quality of life (8-10 on a 0-10 scale).
--
...
select
  'fhi-livskvalitet'::text     as source_id,
  ...
  livskvalitet_code          as score_band,
...
from {{ source('raw', 'fhi_livskvalitet') }}
