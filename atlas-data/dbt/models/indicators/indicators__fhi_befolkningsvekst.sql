...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 185:
-- year-over-year population change, as a count and a percent.
--
...
select
  'fhi-befolkningsvekst'::text  as source_id,
...
from {{ source('raw', 'fhi_befolkningsvekst') }}
