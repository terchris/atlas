...
-- Per-source indicator passthrough for FHI Folkehelsestatistikk table 338:
-- population counts by age band — the demographic denominator.
--
...
select
  'fhi-befolkning'::text        as source_id,
...
from {{ source('raw', 'fhi_befolkning') }}
