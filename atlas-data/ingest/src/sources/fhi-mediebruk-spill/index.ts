/**
 * FHI Folkehelsestatistikk table 601 — Mediebruk_DataTVspill_Ungdata_KH.
 * Share of Ungdata respondents reporting more than 3 hours per day of
 * computer / TV / gaming use. Risk-direction screen-time indicator on
 * the Ungdata cohort base. Pairs with fhi-mediebruk-some (social media)
 * and fhi-mediebruk-underhold (streaming) — together they cover the
 * three-domain time-budget picture.
 */
...
export const SOURCE_ID = "fhi-mediebruk-spill";
const FHI_SOURCE_ID = "nokkel";
const FHI_TABLE_ID = 601;
const TARGET_TABLE = "raw.fhi_mediebruk_spill";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/fhi-mediebruk-spill.ndjson",
);
const WRITE_COLUMNS = [
...
export async function run() {
  return recordIngestRun(SOURCE_ID, async () => {
    ...
    // Cell budget: ~32k full cartesian — trivial; pull everything.
