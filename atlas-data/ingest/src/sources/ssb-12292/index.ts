/**
 * SSB KOSTRA 12292 — Omsorgstjenester (supplerende grunnlagstall). See ./README.md.
 * KOSTRA region dim; 49 content codes.
 */
...
export const SOURCE_ID = "ssb-12292";
const TABLE_ID = "12292";
const TARGET_TABLE = "raw.ssb_12292";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/ssb-12292.ndjson",
);
const WRITE_COLUMNS = [
