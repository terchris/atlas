/**
 * SSB table 10826 — Alders- og kjønnsfordeling for befolkningen i bydeler.
 * See ./README.md for full source notes.
 *
 * Five dimensions: Region × Kjonn × Alder × ContentsCode × Tid. Region is an
 * alphanumeric bydel code dimension that also includes city-total and
 * historical-bydel rows.
 */
...
export const SOURCE_ID = "ssb-10826";
const TABLE_ID = "10826";
const TARGET_TABLE = "raw.ssb_10826";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/ssb-10826.ndjson",
);
...
export async function run(): Promise<Ssb10826Summary> {
...
function toRow(px: PxRow): Ssb10826Row {
