...
export async function run() {
  return recordIngestRun(SOURCE_ID, async () => {
    ...
    // Cell budget: 409 GEO × 1 AAR × 10 ALDER × 8 LANDBAK × 1 MEASURE
    // ≈ 32.7k. Filtering MEASURE_TYPE=TELLER (counts) keeps the response
    // under FHI's 50k cap; RATE / SMR are derivable downstream.
