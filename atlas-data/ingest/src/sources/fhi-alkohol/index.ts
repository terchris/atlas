/**
 * FHI Folkehelsestatistikk table 332 — Alkohol_Ungdata_KH. Share of
 * Ungdata respondents reporting alcohol use one or more times in the
 * past year. Risk-direction youth-substance-use indicator on the same
 * Ungdata cohort base as fhi-livskvalitet / fhi-depresjon /
 * fhi-fortrolig-venn / fhi-smertestillende.
 */
...
export const SOURCE_ID = "fhi-alkohol";
const FHI_SOURCE_ID = "nokkel";
const FHI_TABLE_ID = 332;
const TARGET_TABLE = "raw.fhi_alkohol";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/fhi-alkohol.ndjson",
);
const WRITE_COLUMNS = [
