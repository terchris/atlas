/**
 * SSB KOSTRA 12063 — Kommunale fritidstilbud (municipal leisure services).
 * See ./README.md. Same pattern as ssb-12292 — KOSTRA region dim, content
 * codes for youth centres, volunteer associations receiving public support.
 */
...
export const SOURCE_ID = "ssb-12063";
const TABLE_ID = "12063";
const TARGET_TABLE = "raw.ssb_12063";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/ssb-12063.ndjson",
);
const WRITE_COLUMNS = [
