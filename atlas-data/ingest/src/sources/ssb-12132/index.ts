/**
 * SSB KOSTRA 12132 — Utgifter som inngår i stønadssatsene for økonomisk
 * sosialhjelp. See ./README.md. Identical shape to ssb-12131.
 */
...
export const SOURCE_ID = "ssb-12132";
const TABLE_ID = "12132";
const TARGET_TABLE = "raw.ssb_12132";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/ssb-12132.ndjson",
);
const WRITE_COLUMNS = [
