/**
 * SSB 09429 — Utdanningsnivå, etter kommune og kjønn. See ./README.md.
 * Five dimensions; Nivaa + Kjonn elim=true, but included explicitly.
 */
...
type Row = {
  region_code: string; education_level: string; sex: string; year: number;
  contents_code: string; contents_label: string;
  value: number | null; status: string | null;
};

export const SOURCE_ID = "ssb-09429";
const TABLE_ID = "09429";
const TARGET_TABLE = "raw.ssb_09429";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/ssb-09429.ndjson",
);
const WRITE_COLUMNS = [
  "region_code", "education_level", "sex", "year",
