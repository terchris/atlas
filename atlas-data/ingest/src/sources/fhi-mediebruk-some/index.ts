/**
 * FHI Folkehelsestatistikk table 602 — Mediebruk_SOME_Ungdata_KH. Share
 * of Ungdata respondents reporting more than 3 hours per day of social
 * media use. Risk-direction screen-time indicator on the Ungdata cohort
 * base — the social-media subdomain has the strongest mental-health
 * correlation in the youth-research literature among the three media
 * tables (DataTVspill / SOME / underhold).
 */
...
export const SOURCE_ID = "fhi-mediebruk-some";
const FHI_SOURCE_ID = "nokkel";
const FHI_TABLE_ID = 602;
const TARGET_TABLE = "raw.fhi_mediebruk_some";
const OUTPUT_PATH = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../output/fhi-mediebruk-some.ndjson",
);
const WRITE_COLUMNS = [
...
export async function run() {
  return recordIngestRun(SOURCE_ID, async () => {
    ...
    // Cell budget: ~27k full cartesian — trivial; pull everything.
