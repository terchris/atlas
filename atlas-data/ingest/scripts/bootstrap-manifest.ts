...
/**
 * Render a ManifestStub to YAML. Hand-rolled (no yaml lib dep).
 *
 ...
 *
 * Output shape matches what fill-manifest-todos.ts expects to consume + write
 * back; keep this aligned with renderManifest in fill-manifest-todos.ts.
 */
function renderManifest(m: ManifestStub): string {
  ...
  lines.push(`eu_theme: TODO  # AGRI / ECON / EDUC / ENER / ENVI / GOVE / HEAL / INTR / JUST / REGI / SOCI / TECH / TRAN — usually auto-derived from tags.topic`);
  lines.push(`attribution: TODO  # citation string, e.g. "Kilde: Statistisk sentralbyrå, tabell 08764"`);
  lines.push(``);
  lines.push(`tags:`);
