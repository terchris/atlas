...
import ApiCurl from '@site/src/components/sources/ApiCurl';
...
<ApiCurl query="indicator_summary?kommune_code=eq.3024&select=kommune_name,indicator_id,indicator_label,latest_value,latest_year" />
