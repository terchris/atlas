...
| 11 | [data-discovery-surface](INVESTIGATE-data-discovery-surface.md) | semantic-foundation-before-expansion (Tier 1) | dbt-MCP / OpenMetadata / PostgREST surface choice depends on the semantic format decision. |
