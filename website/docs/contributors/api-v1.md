...
For PostgREST itself (the deployment, role pair, configure semantics), see UIS's [PostgREST service docs](https://github.com/helpers-no/urbalurba-infrastructure/blob/main/website/docs/services/integration/postgrest.md). For the design rationale, see [INVESTIGATE-postgrest-api-v1-wrapper.md](../ai-developer/plans/completed/INVESTIGATE-postgrest-api-v1-wrapper.md). For the build itself, see [PLAN-004-postgrest-api-v1-wrapper.md](../ai-developer/plans/completed/PLAN-004-postgrest-api-v1-wrapper.md).
...
- [INVESTIGATE-postgrest-api-v1-wrapper.md](../ai-developer/plans/completed/INVESTIGATE-postgrest-api-v1-wrapper.md) — design rationale + 18 decision points
- [PLAN-004-postgrest-api-v1-wrapper.md](../ai-developer/plans/completed/PLAN-004-postgrest-api-v1-wrapper.md) — implementation; phase outcomes recorded inline
